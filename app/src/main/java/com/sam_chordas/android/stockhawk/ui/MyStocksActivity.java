...
public class MyStocksActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>, SharedPreferences.OnSharedPreferenceChangeListener{
  ...
  boolean isConnected;
  public static final String TAG = "MyStocksActivity";
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (savedInstanceState == null){
      ...
      if (isConnected){
        ...
        speditor.putInt(mContext.getString(R.string.stock_status_key), StockTaskService.STOCK_STATUS_NO_INTERNET );
        //errorMessage = getResources().getString(R.string.network_toast);
        networkToast();
    ...
    recyclerView.addOnItemTouchListener(new RecyclerViewItemClickListener(this,
            new RecyclerViewItemClickListener.OnItemClickListener() {
              @Override public void onItemClick(View v, int position) {
                ...
                Cursor cursor = (Cursor) mCursorAdapter.getCursor();

                //Toast.makeText(getApplicationContext(), cursor.getCount()+"clicked a item"+position+cursor.getColumnName(1), Toast.LENGTH_LONG).show();
                cursor.getCount();
    ...
    if (isConnected){
      ...
      PeriodicTask periodicTask = new PeriodicTask.Builder()
          ...
          .setPeriod(period)
          .setFlex(flex)
          .setTag(getString(R.string.periodicTag))
  ...
  public void networkToast(){
    ...
    empty_view.setText(errorMessage);
  ...
  public void setEmptyView(int status){
    ...
    switch (status){
      case 1:
        errorMessage = getString(R.string.err_Server_down);
        break;
      case 2:
        errorMessage = getString(R.string.err_Server_Invalid);
        break;
      case 3:
        errorMessage = getString(R.string.err_unknown);
        break;
      case 5:
        errorMessage = getResources().getString(R.string.network_toast);
      default:
  ...
  private void updateWidget(){
    ...
    int [] ids = appWidgetManager.getAppWidgetIds(new ComponentName(this, StocksWidgetProvider.class));
    if(ids.length>=0){
      appWidgetManager.notifyAppWidgetViewDataChanged(ids, R.id.widget_stock_collection);
    }
  ...
  public void onLoadFinished(Loader<Cursor> loader, Cursor data){
    ...
    if (isConnected==false) {
      ...
      Snackbar.make(coordinatorLayout, getString(R.string.string_no_internet),
              Snackbar.LENGTH_LONG).setAction(getString(R.string.try_again), new View.OnClickListener() {
        @Override
        public void onClick(View v) {
          //Toast.makeText(mContext, "Snackbar clicked", Toast.LENGTH_LONG).show();
  ...
  public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
    if(key.equals(getString(R.string.stock_status_key))){
      int i = sharedPreferences.getInt(getString(R.string.stock_status_key), 3);
      Log.d(TAG, "onSharedPreferenceChanged="+i);
